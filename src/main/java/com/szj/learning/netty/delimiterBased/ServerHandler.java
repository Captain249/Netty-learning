package com.szj.learning.netty.delimiterBased;
...
public class ServerHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        ByteBuf rspByteBuf = Unpooled.copiedBuffer((Constant.SERVER_RSP_MSG + Constant.DELIMITER).getBytes(StandardCharsets.UTF_8));
